...
def api_buscar_tmdb():
    ...
    # uso request.args.get porque o "q" vem como parametro na URL (query string), tipo /buscar?q=matrix
    # e uso o get com valor padrao "" pra nao dar erro caso ninguem mande o q na url
